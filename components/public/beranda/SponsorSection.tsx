...
const sponsorGroups: SponsorGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: "akber",         nama: "Akber",            logoFile: "akber.png",          basePath: "/images/medpart/" },
      { id: "bemfkip",       nama: "BEM FKIP",         logoFile: "bemfkip.png",        basePath: "/images/medpart/" },
      { id: "bppi",          nama: "BPPI",             logoFile: "bppi.png",           basePath: "/images/medpart/" },
      { id: "campusquest",   nama: "Campus Quest ID",  logoFile: "campusquest-id.png", basePath: "/images/medpart/" },
      { id: "cendikiasport", nama: "Cendikia Sport",   logoFile: "cendikiasport.png",  basePath: "/images/medpart/" },
      { id: "formaiska",     nama: "FORMAISKA",        logoFile: "formaiska.png",      basePath: "/images/medpart/" },
      { id: "fosmi",         nama: "FOSMI",            logoFile: "fosmi.png",          basePath: "/images/medpart/" },
      { id: "fsldk",         nama: "FSLDK",            logoFile: "fsldk.png",          basePath: "/images/medpart/" },
      { id: "fusi",          nama: "FUSI",             logoFile: "fusi.png",           basePath: "/images/medpart/" },
      { id: "kisr",          nama: "KISR",             logoFile: "kisr.png",           basePath: "/images/medpart/" },
      { id: "lki",           nama: "LKI",              logoFile: "lki.png",            basePath: "/images/medpart/" },
      { id: "ski-fib",       nama: "SKI FIB",          logoFile: "SKI FIB.png",        basePath: "/images/medpart/" },
      { id: "ski-fk",        nama: "SKI FK",           logoFile: "SKI FK.png",         basePath: "/images/medpart/" },
      { id: "ski-fkip",      nama: "SKI FKIP",         logoFile: "SKI FKIP.png",       basePath: "/images/medpart/" },
      { id: "ski-ft",        nama: "SKI FT",           logoFile: "SKI FT.png",         basePath: "/images/medpart/" },
      { id: "ski-sv",        nama: "SKI SV",           logoFile: "SKI SV.png",         basePath: "/images/medpart/" },
      { id: "skimipa",       nama: "SKI MIPA",         logoFile: "skimipa.png",        basePath: "/images/medpart/" },
      { id: "solorayarun",   nama: "Solo Raya Run",    logoFile: "solorayarun.png",    basePath: "/images/medpart/" },
      { id: "ukmi",          nama: "UKMI",             logoFile: "ukmi.png",           basePath: "/images/medpart/" },
    ],
  },
];
