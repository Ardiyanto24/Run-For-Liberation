...
const fotoPlaceholder = [
  {
    id: 1,
    src: "https://placehold.co/600x450/1A54C8/ffffff?text=Run+For+Liberation",
    alt: "Peserta berlari bersama — Run For Liberation 2025",
    caption: "Start & Finish Line",
  },
  {
    id: 2,
    src: "https://placehold.co/600x450/0E2D7A/ffffff?text=Komunitas+Lari",
    alt: "Komunitas lari bersama",
    caption: "Komunitas Bersatu",
  },
  {
    id: 3,
    src: "https://placehold.co/600x450/007A3D/ffffff?text=Solidaritas",
    alt: "Momen solidaritas peserta",
    caption: "Solidaritas Palestina",
  },
  {
    id: 4,
    src: "https://placehold.co/600x450/CE1126/ffffff?text=Race+Day",
    alt: "Hari H race day",
    caption: "Race Day 2025",
  },
  {
    id: 5,
    src: "https://placehold.co/600x450/4A7CE8/ffffff?text=Finish+Line",
    alt: "Peserta melewati garis finish",
    caption: "Garis Finish",
  },
  {
    id: 6,
    src: "https://placehold.co/600x450/1340A0/ffffff?text=Bersama+Gaza",
