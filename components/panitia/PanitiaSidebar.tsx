// components/panitia/PanitiaSidebar.tsx
...
const NAV_ITEMS: NavItem[] = [
  ...
  { label: "Laporan Keuangan",    href: "/panitia/laporan",           icon: <IconLaporan />    },
...
interface PanitiaSidebarProps {
  isOpen: boolean;
  onClose: () => void;
}

export default function PanitiaSidebar({ isOpen, onClose }: PanitiaSidebarProps) {
  ...
  return (
    <>
      ...
      <aside
        ...
        aria-label="Sidebar navigasi panitia"
      >
        {/* ── BRAND ── */}
        ...
        <div className="px-5 pt-4 pb-2">
          <div className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-[#1A54C8]/20 border border-[#1A54C8]/30">
            <div className="w-1.5 h-1.5 rounded-full bg-[#4A9CE8] animate-pulse" />
            <span className="text-[10px] font-semibold text-[#4A9CE8] uppercase tracking-[0.12em] font-['Barlow_Condensed']">
              Panitia
            </span>
          </div>
        </div>
