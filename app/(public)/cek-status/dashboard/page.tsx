...
export default function DashboardPesertaPage() {
  ...
  // Pilih data dummy berdasarkan status yang dipilih
  const peserta = dummyDashboardData[demoStatus];

  return (
    <div className="min-h-screen bg-[#F5F8FF]">

      {/* ── Demo Switcher — paling atas, full width ── */}
      <DemoStatusSwitcher
      ...
      <div className="max-w-2xl mx-auto px-4 py-10 flex flex-col gap-6">
        ...
        <div className="bg-white rounded-[16px] border border-[rgba(26,84,200,0.13)] shadow-[0_2px_16px_rgba(10,22,40,0.07)] px-7 py-6">
          <div className="flex flex-col gap-3">
            ...
            {/* Baris atas: salam + badge kategori */}
        ...
        {/* VERIFIED: E-Ticket dulu, baru Detail */}
        ...
        {/* PENDING: Pesan informatif + Detail */}
        ...
        {/* DITOLAK: Pesan sopan + Detail + Tombol hubungi */}
        {peserta.status === "DITOLAK" && (
          <>
            ...
            {/* TODO: ganti href dengan nomor WhatsApp panitia yang benar */}
            <a
