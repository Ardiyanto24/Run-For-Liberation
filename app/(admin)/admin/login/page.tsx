...
export default function AdminLoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Kredensial demo hardcode — diganti Server Action di DEV-09
    if (
      ...
      // Pesan generik — tidak membocorkan apakah email atau password yang salah
      setError("Email atau password tidak valid.");
      setIsLoading(false);
    }
  };
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center relative overflow-hidden"
      style={{ background: "linear-gradient(135deg, #0E2D7A 0%, #0A1628 60%, #1A54C8 100%)" }}
    >
      ...
      <div className="w-full max-w-[400px] mx-4">
        ...
        <div
          ...
          style={{ boxShadow: "0 24px 64px rgba(10, 22, 40, 0.4), 0 8px 24px rgba(26, 84, 200, 0.2)" }}
        >
          {/* Header card */}
          <div className="mb-6">
            ...
            <p className="text-[#6B7A99] text-sm ml-10" style={{ fontFamily: "'Barlow', sans-serif" }}>
